...
A interface é composta de dois campos de texto, um editável com subtitulo
"comandos" e outro não esditável com subtítulo "texto".
...
o texto com os caracteres removidos deve ser exibido no campo "texto".
...
Salvar: Ao clicar no botão "Salvar", é iniciada uma thread, caso ela não esteja iniciada, e começa
...
o arquivo que estava sendo editado, também limpa quaisquer vestigios do arquivo que estava sendo editado,
